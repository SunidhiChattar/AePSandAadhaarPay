...
public class LibActivity extends AppCompatActivity {
    ...
    private String dataObjectAsAString;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        progressLoadingDialog = new ProgressDialog(LibActivity.this);
    ...
    public void getLocation() {
        gpsTracker = new GpsTracker(LibActivity.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (data != null && resultCode == RESULT_OK) {
            if (data.hasExtra("error1Response")) {
                Intent intent = new Intent(LibActivity.this, ErrorActivity.class);
                intent.putExtra("errorResponse", data.getIntExtra("error1Response", 0));
                startActivity(intent);
                finish();
            } else if (data.hasExtra("errorResponse")) {
                Intent intent = new Intent(LibActivity.this, Error2Activity.class);
                ...
                if(SdkConstants.transactionType.equalsIgnoreCase( "POS")) {
                    ...
                    Intent intent = new Intent(LibActivity.this, TransactionStatusPOSActivity.class);
                    ...
                    Intent intent = new Intent(LibActivity.this, TransactionStatusActivity.class);
...
//                    .show();
    ...
    public void checkAppInstalledOrNot(String packageName){
        ...
        dataObjectAsAString = getIntent().getStringExtra("Data");
        try {
            if (installed) {
                PackageManager manager = getPackageManager();
                Intent sIntent = manager.getLaunchIntentForPackage(packageName);
                sIntent.setFlags(0);
//                sIntent.putExtra("ActivityName", "lib");
                sIntent.putExtra("dataToService",dataObjectAsAString);
                dataObjectAsAString = getIntent().getStringExtra("data");
                sIntent.addCategory(Intent.CATEGORY_LAUNCHER);
                startActivityForResult(sIntent, 55);
                ...
                if(packageName.equals("com.matm.matmservice_1")) {
                    showAlert(LibActivity.this);
                }else {
                    showMatmAlert(LibActivity.this);
                }
            }
        } catch (Exception e) {
        }
        ...
        checkKycStatusResponseModelCall.enqueue(new Callback<CheckKycStatusResponseModel>() {
            ...
            public void onResponse(@NonNull Call<CheckKycStatusResponseModel> call, @NonNull Response<CheckKycStatusResponseModel> response) {
                if (response.body() != null) {
                    ...
                    if (response.body().getStatus() == 1) {
                        ...
                        if(commonOnBoardingStatus==0){
                            if(posStatus.equalsIgnoreCase("SUCCESS") && posSub_Status == 0 ){
                                Intent intent = new Intent(LibActivity.this, POSTransactionDetailsActivity.class);
                                startActivity(intent);
                                finish();
                            }else if (posStatus.equalsIgnoreCase("NA")){
                                Intent intent = new Intent(LibActivity.this, POSSettlementAccountActivity.class);
                                startActivity(intent);
                                finish();
                            }else{
                                showOnBoardingFailAlert(LibActivity.this,message);

                            }
                        }else{
                            showOnBoardingFailAlert(LibActivity.this,"Please complete your onboarding process to continue the transaction.");
                        }
                    ...
                    showOnBoardingFailAlert(LibActivity.this,"Please try again after sometime !!");
                    progressLoadingDialog.dismiss();
                }
            }
