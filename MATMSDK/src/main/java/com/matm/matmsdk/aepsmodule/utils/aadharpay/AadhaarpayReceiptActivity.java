...
import com.matm.matmsdk.aepsmodule.utils.aadharpay.Model.FCMNotificationData;
...
//                Chunk mOrdertxnAmtChunk = new Chunk("Transaction Amount: " + tv_transactionAmount.getText().toString().substring(12), mOrderIdFont);
                ...
                Chunk mOrdertxnTypeChunk = new Chunk("Transaction Type: " + "AadharPay", mOrderIdFont);
...
//                editText.setText("ID " + data);
    ...
    private void printReceipt() {
        ...
        try {
            ...
            result = mPrinter.printString("Transaction Id :"+txnIdForPdf,20, Printer.Align.LEFT,false,false);
            result = mPrinter.printString("Aadhaar Number :"+aadhaarNumber_dialog,20, Printer.Align.LEFT,false,false);
            result = mPrinter.printString("Date/Time : "+tv_dateTime.getText().toString().trim(),20, Printer.Align.LEFT,false,false);
            result = mPrinter.printString("Bank Name : "+tv_bankName.getText().toString(),20, Printer.Align.LEFT,false,false);

            result = mPrinter.printString("RRN :"+rrNumber_dialog,20, Printer.Align.LEFT,false,false);
            result = mPrinter.printString("Balance Amount :"+balanceAmt_dialog,20, Printer.Align.LEFT,false,false);
            result = mPrinter.printString("Transaction Amount : Rs. "+SdkConstants.transactionAmount,20, Printer.Align.LEFT,false,false);
            result = mPrinter.printString("Transaction Type :"+"AadhaarPay",20, Printer.Align.LEFT,false,false);
