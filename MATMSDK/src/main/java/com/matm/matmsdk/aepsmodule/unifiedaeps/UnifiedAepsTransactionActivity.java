...
public class UnifiedAepsTransactionActivity extends AppCompatActivity implements IAemCardScanner, IAemScrybe {
    ...
    public static final String TAG = UnifiedAepsTransactionActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (SdkConstants.aepsStatusLayout == 0) {
            setContentView(R.layout.activity_transactionstatus_unifiedaeps);
        } else {
        ...
        m_AemScrybeDevice = new AEMScrybeDevice(UnifiedAepsTransactionActivity.this);
        ...
        session = new Session(UnifiedAepsTransactionActivity.this);

        transactionStatusModel = getIntent().getParcelableExtra(SdkConstants.TRANSACTION_STATUS_KEY);


        if (getIntent().getParcelableExtra(SdkConstants.TRANSACTION_STATUS_KEY) == null) {
            ...
            if (transactionStatusModel != null && transactionStatusModel.getStatus() != null) {
                if (transactionStatusModel.getStatus().equalsIgnoreCase("SUCCESS")) {
                    ...
                    if (transactionStatusModel.getCreatedDate() != null && !transactionStatusModel.getCreatedDate().matches("")) {
                        date_time.setText(transactionStatusModel.getCreatedDate());
                    }
                    ...
                    if (transactionStatusModel.getBalanceAmount() != null && !transactionStatusModel.getBalanceAmount().matches("") && !transactionStatusModel.getBalanceAmount().equalsIgnoreCase("N/A")) {
                        balance = "Rs. " + transactionStatusModel.getBalanceAmount();
                    }
                    ...
                    if (transactionStatusModel.getTransactionType() != null) {
                        if (transactionType.equalsIgnoreCase("AEPS_CASH_WITHDRAWAL")) {
                            txnID.setText("Transaction ID: " + txnid);
                            bank_name.setText(bankName);
                            card_amount.setText("Txn Amount: Rs. " + SdkConstants.transactionAmount);
                        } else if (transactionType.equalsIgnoreCase("AEPS_BALANCE_ENQUIRY")) {
                            txnID.setText("Transaction ID: " + txnid);
                            bank_name.setText(bankName);
                            card_amount.setText("Balance Amount: " + balance);
                        } else {
                            txnID.setText("Transaction ID: " + txnid);
                            bank_name.setText(bankName);
                            card_amount.setText("Balance Amount: " + balance);
                    ...
                    if (transactionStatusModel.getIsRetriable() == true) {
                        retryBtn.setVisibility(View.VISIBLE);
                        aadharCard = transactionStatusModel.getAadharCard();
                        if (transactionStatusModel.getAadharCard() == null) {
                            aadharCard = "N/A";
        ...
        txndetails.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                showTransactionDetails(UnifiedAepsTransactionActivity.this);
            }
        });
        ...
        retryBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(UnifiedAepsTransactionActivity.this, UnifiedAepsActivity.class);
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Intent mainActivity = new Intent(UnifiedAepsTransactionActivity.this, MainActivity.class);
        ...
        downloadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (checker.lacksPermissions(REQUIRED_PERMISSION)) {
                    PermissionsActivity.startActivityForResult(UnifiedAepsTransactionActivity.this, PERMISSION_REQUEST_CODE, REQUIRED_PERMISSION);
                } else {
                    Date date = new Date();
...
//    }
    ...
    public void createPdfGenericMethod(String dest) {
        ...
        try {
            ...
            p1.add(new Chunk("Unified AePS", mOrderDateValueFont));
            document.add(p1);
            ...
            if (transactionType.equalsIgnoreCase("AEPS_CASH_WITHDRAWAL")) {
                Chunk mOrdertxnAmtChunk = new Chunk("Transaction Amount: Rs." + SdkConstants.transactionAmount, mOrderIdFont);
                Paragraph mOrdertxnAmtParagraph = new Paragraph(mOrdertxnAmtChunk);
                document.add(mOrdertxnAmtParagraph);

            } else {
                Chunk mOrdertxnAmtChunk = new Chunk("Transaction Amount: " + "N/A", mOrderIdFont);
                Paragraph mOrdertxnAmtParagraph = new Paragraph(mOrdertxnAmtChunk);
                document.add(mOrdertxnAmtParagraph);
            }
            ...
            Intent intent = new Intent(UnifiedAepsTransactionActivity.this, PreviewPDFActivity.class);
    ...
    private void showBrandSetAlert() {
        try {
            AlertDialog.Builder builder1 = new AlertDialog.Builder(UnifiedAepsTransactionActivity.this);
    ...
    private void getPrintData(final String txnId, final String adharcard, final String date, final String bankname,
        ...
        new Thread(new Runnable() {
            public void run() {
                ...
                GetConnectToPrinter.getInstance().step(Integer.parseInt("10"));
                GetConnectToPrinter.getInstance().printStr("Transaction Type :" + type, null);
                GetConnectToPrinter.getInstance().step(Integer.parseInt("10"));
                ...
                GetConnectToPrinter.getInstance().spaceSet((byte) 0, (byte) 0);
                GetConnectToPrinter.getInstance().leftIndents(Short.parseShort("0"));
                GetConnectToPrinter.getInstance().printStr("Transaction Amount: Rs." + SdkConstants.transactionAmount, null);
    ...
    private void callBluetoothFunction(final String txnId, final String aadharNo, final String date, final String bank_name, final String reffNo, final String type, View view) {
        ...
        try {
            ...
            m_AemPrinter.print("\n");
            m_AemPrinter.print("Aadhaar Number: " + aadharCard);
            m_AemPrinter.print("\n");
            ...
            m_AemPrinter.print("\n");
            if (transactionType.equalsIgnoreCase("AEPS_CASH_WITHDRAWAL")) {
                m_AemPrinter.print("Transaction Amount: Rs. " + SdkConstants.transactionAmount);
            } else {
                m_AemPrinter.print("Transaction Amount: " + "N/A");
            }
            m_AemPrinter.print("\n");
            m_AemPrinter.print("Transaction Type: " + type);
            m_AemPrinter.print("\n\n");
            m_AemPrinter.setFontType(AEMPrinter.FONT_002);
...
//        });
            ...
            AndroidNetworking.post("https://wallet-deduct-sms-vn3k2k7q7q-uc.a.run.app/")
                    ...
                    .getAsJSONObject(new JSONObjectRequestListener() {
                        ...
                        public void onResponse(JSONObject response) {
                            try {
                                ...
                                if (status.equalsIgnoreCase("0")) {
                                    ...
                                    hideLoader();
                                    Toast.makeText(UnifiedAepsTransactionActivity.this, "Message Sent Successfully . ", Toast.LENGTH_SHORT).show();
                                } else {
                                    hideLoader();
                                    Toast.makeText(UnifiedAepsTransactionActivity.this, msg, Toast.LENGTH_SHORT).show();
                                }
                        ...
                        public void onError(ANError anError) {
                            ...
                            hideLoader();
                            Toast.makeText(UnifiedAepsTransactionActivity.this, "Wallet balance not available", Toast.LENGTH_SHORT).show();
                        }
                    });
    ...
    public void showLoader() {
        if (progressDialog == null) {
            progressDialog = new ProgressDialog(UnifiedAepsTransactionActivity.this);
    ...
    public void showTransactionDetails(Activity activity) {
        try {
            ...
            TextView aadhar_number = (TextView) dialog.findViewById(R.id.midNo);
            TextView rref_num = (TextView) dialog.findViewById(R.id.rrnNo);
            TextView card_transaction_type = (TextView) dialog.findViewById(R.id.terminalId);
    ...
    public void onBackPressed() {
     ...
     /*  try {
            if (statusTxt.equalsIgnoreCase("FAILED") && transactionStatusModel.getIsRetriable() == true ) {
                Intent intent = new Intent(UnifiedAepsTransactionActivity.this, UnifiedAepsActivity.class);
                intent.putExtra("FAILEDVALUE", "FAILEDDATA");
                startActivity(intent);
                finish();
    ...
    private void getConnection(View view) {
        ...
        if (bluetoothAdapter == null) {
            Toast.makeText(UnifiedAepsTransactionActivity.this, "Bluetooth NOT supported", Toast.LENGTH_SHORT).show();
        } else {
...
//                    editText.setText(response.replace("^",""));
    ...
    public boolean onContextItemSelected(@NonNull MenuItem item) {
        ...
        try {
            ...
            Toast.makeText(UnifiedAepsTransactionActivity.this, "Connected with " + printerName, Toast.LENGTH_SHORT).show();
...
//            m_AemPrinter.print(data);
            ...
            if (e.getMessage().contains("Service discovery failed")) {
                Toast.makeText(UnifiedAepsTransactionActivity.this, "Not Connected\n" + printerName + " is unreachable or off otherwise it is connected with other device", Toast.LENGTH_SHORT).show();
            } else if (e.getMessage().contains("Device or resource busy")) {
                Toast.makeText(UnifiedAepsTransactionActivity.this, "the device is already connected", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(UnifiedAepsTransactionActivity.this, "Unable to connect", Toast.LENGTH_SHORT).show();
            }
        }
        return true;
    }
    ...
    public void showAlert(String alertMsg) {
        android.app.AlertDialog.Builder alertBox = new android.app.AlertDialog.Builder(UnifiedAepsTransactionActivity.this);
    ...
    private class UnifiedPrintReceiptThread extends Thread {
        @Override
        public void run() {
            mPrinter = new Printer(UnifiedAepsTransactionActivity.this);
            try {
    ...
    private void printReceipt() {
        ...
        try {
            ...
            result = mPrinter.printString("Transaction Report", 25, Printer.Align.CENTER, true, false);
            if (statusTxt.equalsIgnoreCase("FAILED")) {
                result = mPrinter.printString("Failure", 25, Printer.Align.CENTER, true, false);
            } else {
            ...
            result = mPrinter.printString("Transaction Id :" + txnid, 18, Printer.Align.LEFT, true, false);
            result = mPrinter.printString("Aadhaar Number :" + aadharCard, 18, Printer.Align.LEFT, true, false);
            result = mPrinter.printString("Date/Time : " + date_time.getText().toString().trim(), 18, Printer.Align.LEFT, false, false);
            result = mPrinter.printString("Bank Name : " + bankName, 18, Printer.Align.LEFT, true, false);

            result = mPrinter.printString("RRN : " + referenceNo, 18, Printer.Align.LEFT, true, false);
            result = mPrinter.printString("Balance Amount :" + balance, 18, Printer.Align.LEFT, true, false);
            if (transactionType.equalsIgnoreCase("AEPS_CASH_WITHDRAWAL")) {
                result = mPrinter.printString("Transaction Amount : Rs ." + SdkConstants.transactionAmount, 18, Printer.Align.LEFT, true, false);
            } else {
                result = mPrinter.printString("Transaction Amount :" + "N/A", 18, Printer.Align.LEFT, true, false);
            }
            result = mPrinter.printString("Transaction Type : " + transactionType, 18, Printer.Align.LEFT, true, false);
            result = mPrinter.printStringExt("Thank You !", 0, 0f, 2.0f, Printer.Font.SANS_SERIF, 18, Printer.Align.RIGHT, true, true, false);
            result = mPrinter.printStringExt(SdkConstants.BRAND_NAME, 0, 0f, 2.0f, Printer.Font.SANS_SERIF, 18, Printer.Align.RIGHT, true, true, false);
    ...
    private void getConnectToPrinter(View v) {
        registerForContextMenu(printBtn);
        if (bluetoothAdapter == null) {
            Toast.makeText(UnifiedAepsTransactionActivity.this, "Bluetooth NOT supported", Toast.LENGTH_SHORT).show();
        } else {
