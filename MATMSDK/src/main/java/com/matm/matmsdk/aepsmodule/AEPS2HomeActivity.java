...
public class AEPS2HomeActivity extends AppCompatActivity implements BalanceEnquiryContract.View, CashWithDrawalContract.View, OnDriverDataListener {
                ...
                try {
                    ...
                    if (SdkConstants.MANUFACTURE_FLAG.equalsIgnoreCase(fmDeviceId) || SdkConstants.MANUFACTURE_FLAG.contains(fmDeviceId4) || SdkConstants.MANUFACTURE_FLAG.equalsIgnoreCase(fmDeviceId2) || SdkConstants.MANUFACTURE_FLAG.equalsIgnoreCase(fmDeviceId3)) {
                        ...
                        if(mobileNumber.getText().toString().isEmpty() || bankspinner.getText().toString().isEmpty()){
                            hideLoader();
                            Toast.makeText(AEPS2HomeActivity.this, "Fill up details", Toast.LENGTH_SHORT).show();
                        }else{
                            fingerprint.setEnabled(false);
                            ...
                            if(SdkConstants.onDriverDataListener != null){
                                SdkConstants.onDriverDataListener.onFingerClick(balanaceInqueryAadharNo,
                                        ...
                                        flagNameRdService
                                        ,session.getFreshnessFactor(),AEPS2HomeActivity.this);
                                hideLoader();
                                finish();
                            }
                        }
                        ...
                        if (SdkConstants.transactionType.equalsIgnoreCase(SdkConstants.balanceEnquiry)) {
                            ...
                            try {
                                ...
                                balanceEnquiryaeps2RequestModel = new BalanceEnquiryAEPS2RequestModel("", balanaceInqueryAadharNo, vid, CI, DC, "",
                                        ...
                                        SdkConstants.paramC, lastLatlong, hashString, isBE);
                    ...
                    if (SdkConstants.transactionType.equalsIgnoreCase(SdkConstants.balanceEnquiry)) {
                        ...
                        try {
                            ...
                            cashWithdrawalaeps2RequestModel = new CashWithdrawalAEPS2RequestModel(amountEnter.getText().toString().trim(), balanaceInqueryAadharNo, vid,
                                    ...
                                    session.getUserName(), SdkConstants.isSL, SdkConstants.paramA, SdkConstants.paramB, SdkConstants.paramC, lastLatlong, hashString);
                            cashWithdrawalPresenter = new CashWithdrawalPresenter(AEPS2HomeActivity.this);
                            checkVPNstatusForTransaction("Cash");
    ...
    LocationListener mLocationListener = new LocationListener() {
        ...
        public void onLocationChanged (Location location){
            ...
            if ( validLatLng(location.getLatitude(), location.getLongitude())) {
                ...
                latLong = latitude + "," + longitude;
                Toast.makeText(AEPS2HomeActivity.this, "onlocation == " + latLong, Toast.LENGTH_SHORT).show();
...
//            e.printStackTrace();
//        }
        SingletonClass.getInstance().showAlert(msg, AEPS2HomeActivity.this);
...
//        AlertDialog.Builder alertDialog = new AlertDialog.Builder(AEPS2HomeActivity.this);
...
//        });
//        alertDialog.show();
        SingletonClass.getInstance().showSettingsAlert(AEPS2HomeActivity.this);
    }
