...
//                    editText.setText(response.replace("^",""));
    ...
    private class PrintReceiptThread extends Thread{
        @Override
        public void run() {
            mPrinter=new Printer(TransactionStatusAeps2Activity.this);
            try {
    ...
    private void printReceipt() {
        ...
        try {
            ...
            result = mPrinter.printString("Transaction Id :"+txnid,20, Printer.Align.LEFT,false,false);
            result = mPrinter.printString("Aadhaar Number :"+aadharCard,20, Printer.Align.LEFT,false,false);
            result = mPrinter.printString("Date/Time : "+date_time.getText().toString().trim(),20, Printer.Align.LEFT,false,false);
            result = mPrinter.printString("Bank Name : "+bankName,20, Printer.Align.LEFT,false,false);
            result = mPrinter.printString("RRN :"+referenceNo,20, Printer.Align.LEFT,false,false);
            result = mPrinter.printString("Balance Amount :"+balance,20, Printer.Align.LEFT,false,false);
            result = mPrinter.printString("Transaction Amount :"+amount,20, Printer.Align.LEFT,false,false);
            result = mPrinter.printString("Transaction Type :"+transactionType,20, Printer.Align.LEFT,false,false);
