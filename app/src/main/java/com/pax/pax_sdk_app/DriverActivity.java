...
import static com.matm.matmsdk.Utils.SdkConstants.internalFPName;
...
//                Toast.makeText(this, "App Not Installed", Toast.LENGTH_SHORT).show();
            ...
            //  evoluteCapture();
        } else if (internalFPName.equalsIgnoreCase("wiseasy")){
                    ...
                    try {
                        ...
                        if (bundle != null) {
                            ...
                            if (result != null) {
                                ...
                                Log.d("WiseasyDriverActivity", "aratekPidData " + aratekPidData);
                                Log.d("WiseasyDriverActivity", "aratekresult " + result);
